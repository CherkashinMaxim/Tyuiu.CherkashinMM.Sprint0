using Tyuiu.CherkashinMM.Sprint0.Task7.V0.Lib;
...
namespace Tyuiu.CherkashinMM.Sprint0.Task7.V0
{
    internal class Program
    {
        ...
        {
            Console.Title = "Спринт #0 | Выполнил: Черкашин М. М. | ИИПб-24-1";
            Console.WriteLine("***************************************************************************");
            ...
            Console.WriteLine("* Написать консольную команду на C#, которая суммирует значения двух      *");
            ...
            {
                int[] res = DataService.AdditionArrays(arrayNums1, arrayNums2);
